...
def main():
    ...
    ap.add_argument("--value-mix", dest="value_mix", type=float, default=0.0,
                    help="mix the MCTS root value into the TRAINING value target (see "
                         "kdagent.train --value-mix). Needs corpora generated by this build.")
        ...
        while True:
            ...
            if not cur["trained"]:
                ...
                run_phase("train", [
                    ...
                    "--ch", str(args.ch), "--value-mix", str(args.value_mix),
